...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "activity.running": "{count} 个进程正在运行",
    ...
    "terminal.noProject": "尚未选择项目",
    "terminal.empty": "在当前 Pi 会话中运行命令。",
    "terminal.placeholder": "输入 Shell 命令",
    "terminal.run": "运行",
    "terminal.stop": "停止",
    "terminal.running": "正在运行…",
    "terminal.cancelled": "命令已取消",
    "terminal.exitCode": "进程退出码：{code}",
    ...
    "chat.sideChat": "侧边聊天",
    "chat.sideChatPlaceholder": "输入侧边问题",
    "chat.sideChatInput": "侧边聊天输入",
    "chat.fullAccess": "完全访问",
    "chat.sideChatEmpty": "输入一个侧边问题",
    ...
    "chat.contextWindow": "背景信息窗口",
    "chat.contextPercentUsed": "已用 {percent}%",
    "chat.contextTokensUsed": "已用 {used} 标记，共 {total}",
    "i18n.close": "关闭",
    "i18n.copy": "复制",
    "i18n.copied": "已复制",
    "i18n.cancel": "取消",
