...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "activity.running": "{count} 個程序正在執行",
    ...
    "sidebar.projectOptions": "專案選項",
    "sidebar.organizeSidebar": "整理側邊欄",
    "sidebar.byProject": "按專案",
    "sidebar.inOneList": "在一個列表中",
    "sidebar.chatSort": "聊天排序方式",
    "sidebar.sort.priority": "優先級",
    ...
    "terminal.noProject": "尚未選擇專案",
    "terminal.empty": "在目前 Pi 工作階段中執行命令。",
    "terminal.placeholder": "輸入 Shell 命令",
    "terminal.run": "執行",
    "terminal.stop": "停止",
    "terminal.running": "執行中…",
    "terminal.cancelled": "命令已取消",
    "terminal.exitCode": "程序結束代碼：{code}",
    ...
    "chat.sideChat": "側邊聊天",
    "chat.sideChatPlaceholder": "輸入側邊問題",
    "chat.sideChatInput": "側邊聊天輸入",
    "chat.fullAccess": "完全存取",
    "chat.sideChatEmpty": "輸入一個側邊問題",
    "chat.sideChatThinking": "思考",
    "chat.sideChatTool": "工具",
    ...
    "chat.contextWindow": "背景資訊視窗",
    "chat.contextPercentUsed": "已使用 {percent}%",
    "chat.contextTokensUsed": "已使用 {used} 個標記，共 {total}",
    "i18n.close": "關閉",
    "i18n.copy": "複製",
    "i18n.copied": "已複製",
    "i18n.cancel": "取消",
