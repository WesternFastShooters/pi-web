...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "activity.running": "{count} process running",
    ...
    "sidebar.chatSort": "Chat sorting",
    "sidebar.sort.priority": "Priority",
    "sidebar.sort.recent": "Recent updates",
    "sidebar.sort.manual": "Manual",
    "sidebar.removeProject": "Remove project",
    "sidebar.revealInFinder": "Show in Finder",
    ...
    "terminal.noProject": "No project selected",
    "terminal.empty": "Run a command in the current Pi session.",
    "terminal.placeholder": "Type a shell command",
    "terminal.run": "Run",
    "terminal.stop": "Stop",
    "terminal.running": "Running…",
    "terminal.cancelled": "Command cancelled",
    ...
    "chat.startTaskTitle": "What are we building?",
    ...
    "chat.sideChatPlaceholder": "Ask a side question",
    "chat.sideChatInput": "Side chat input",
    "chat.fullAccess": "Full access",
    "chat.sideChatEmpty": "Ask a side question",
    "chat.sideChatThinking": "Thinking",
    "chat.sideChatTool": "Tool",
